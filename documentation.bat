...
@echo off & setlocal enableDelayedExpansion & exit

set "revisionRequired=3.29.7"
...
rem /rgb 	  - must surroud your color codes in quotes ""
...
rem 			USE AS COMMANDS
rem
rem 		a. %curl% <CURL SYNTAX>
rem 		b. %nircmd% <NIRCMD SYNTAX>
rem 		c. %wget% <WGET SYNTAX>
